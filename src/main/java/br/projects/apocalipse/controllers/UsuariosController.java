...
public class UsuariosController {
	 ...
	 * @param id
	 * @param localizacao
	 * @return retorna JSON do usuário atualizado ou vazio se o usuário não existe
	 */
	 ...
	 * @param id
	 * @param item
	 * @return retorna JSON do usuário atualizado ou vazio se o item não existe ou usuário não existe
	 */
